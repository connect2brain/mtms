...
public:
  ...
  bool is_finished();
  bool success();
  std::vector<eeg_interfaces::msg::EegSample>& get_eeg_buffer();
...
private:
  ...
  bool handle_state__gather_data(double_t current_time, const std::shared_ptr<eeg_interfaces::msg::EegSample> msg);

  std::vector<eeg_interfaces::msg::EegSample> eeg_buffer;
