...
bool EegGatherer::handle_state__gather_data(double_t current_time, const std::shared_ptr<eeg_interfaces::msg::PreprocessedSample> msg) {
...
std::vector<eeg_interfaces::msg::PreprocessedSample>& EegGatherer::get_eeg_buffer() {
  assert (is_finished());
