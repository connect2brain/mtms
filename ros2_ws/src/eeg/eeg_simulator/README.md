...
The file `random_data.csv` contains 100 lines of random values between 0 and 1, 64 values per line (i.e., 0.2 seconds of data with the sampling frequency 500 Hz, 62 EEG and 2 EMG channels).
