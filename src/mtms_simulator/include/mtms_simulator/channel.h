...
public:
  ...
  event_msgs::msg::ChargeFeedback charge(uint16_t target_voltage, uint16_t event_id);
  event_msgs::msg::DischargeFeedback discharge(uint16_t requested_target_voltage, uint16_t event_id);
  event_msgs::msg::PulseFeedback pulse(uint16_t event_id, uint16_t duration_ticks);
