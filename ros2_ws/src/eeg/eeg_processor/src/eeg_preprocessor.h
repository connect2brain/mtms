...
class EegPreprocessor : public ProcessorNode<eeg_interfaces::msg::EegSample, eeg_interfaces::msg::EegSample> {
public:
  EegPreprocessor();
private:
  ...
  rclcpp::Publisher<eeg_interfaces::msg::EegSample>::SharedPtr cleaned_eeg_publisher;
