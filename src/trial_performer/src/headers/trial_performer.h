...
private:
  ...
  std::pair<std::vector<event_interfaces::msg::Pulse>, std::vector<uint16_t>> create_pulses(
      const std::vector<waveform_interfaces::msg::WaveformsForCoilSet> &waveforms, const trial_interfaces::msg::Trial &trial, double start_time);
  ...
  std::pair<std::vector<event_interfaces::msg::TriggerOut>, std::vector<uint16_t>> create_trigger_outs(
      const trial_interfaces::msg::Trial &trial, double pulse_time);
  ...
  /* Publishers */
  void create_marker(const trial_interfaces::msg::Trial &trial);
  ...
  bool perform_trial(const trial_interfaces::msg::Trial &trial);
