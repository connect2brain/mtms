...
MatlabProcessor::MatlabProcessor(const std::string &script_path) {
  std::cout << "Staring matlab" << std::endl;
  ...
  matlab->eval(u"addpath '/home/alqio/workspace/mtms/ros2_ws/src/processors/matlab'");
  ...
  matlab::data::TypedArray<int16_t> result = matlab->feval(u"simple_script", args);
