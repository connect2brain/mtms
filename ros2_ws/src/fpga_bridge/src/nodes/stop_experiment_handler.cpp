...
public:
  StopExperiment()
    ...
    stop_experiment_service_ = this->create_service<fpga_interfaces::srv::StopExperiment>("/fpga/stop_experiment",
                                                                                          stop_experiment);
  }
...
int main(int argc, char **argv) {
  ...
  RCLCPP_INFO(rclcpp::get_logger("stop_experiment_handler"), "Setting thread scheduling and memory lock");
