  ...
  EField() : Node("efield") {
    ...
    auto service_callback_efield_vector = [this](
      ...
      auto service_callback_efield_vector_ROI=[this](const std::shared_ptr<neuronavigation_interfaces::srv::EfieldRoi::Request> request,
          ...
          efield_estimation_ROI(position, request->transducer_rotation, request->id_list,response->efield_data.enorm, response->efield_data.column1, response->efield_data.column2, response->efield_data.column3, response->efield_data.maxindex);

      };

      auto service_callback_efield_vector_ROI_max_loc=[this](const std::shared_ptr<neuronavigation_interfaces::srv::EfieldRoi::Request> request,
                                                     std::shared_ptr<neuronavigation_interfaces::srv::EfieldRoi::Response> response)-> void {
          ...
          efield_estimation_ROI_max_loc(position, request->transducer_rotation, request->id_list,response->efield_data.enorm, response->efield_data.column1, response->efield_data.column2, response->efield_data.column3, response->efield_data.maxindex);
    ...
    auto service_callback_set_coil=[this](const std::shared_ptr<neuronavigation_interfaces::srv::SetCoil::Request> request,
      ...
      efield_service_vectorfield_ROI_max_loc = this->create_service<neuronavigation_interfaces::srv::EfieldRoi>("/efield/get_ROIefieldvectorMax", service_callback_efield_vector_ROI_max_loc);
...
private:
  ...
  rclcpp::Service<neuronavigation_interfaces::srv::EfieldRoi>::SharedPtr efield_service_vectorfield_ROI_max_loc;
