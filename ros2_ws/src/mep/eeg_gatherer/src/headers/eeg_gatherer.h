...
public:
  ...
  void handle_eeg_sample(const std::shared_ptr<eeg_msgs::msg::Sample> msg);
  bool is_finished();
  bool success();
  std::vector<eeg_msgs::msg::Sample>& get_eeg_buffer();
...
private:
  ...
  bool handle_state__gather_data(double_t current_time, const std::shared_ptr<eeg_msgs::msg::Sample> msg);
