...
class MTMSApi:
    ...
    def wait_for_completions(self, ids):
        for id in ids:
    ...
    def send_instant_charge_or_discharge_to_all_channels(self, target_voltages, wait_for_completion=True):
    ...
    def send_instant_full_discharge_to_all_channels(self, wait_for_completion=True):
        target_voltages = self.N_CHANNELS * [0]

        ids = self.send_instant_charge_or_discharge_to_all_channels(
    ...
    def send_instant_default_pulse_to_all_channels(self, reverse_polarities, wait_for_completion=True):
