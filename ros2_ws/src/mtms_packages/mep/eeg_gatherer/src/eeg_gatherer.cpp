...
EegGatherer::EegGatherer(std::string goal_id, double_t start_time, double_t end_time) {
  ...
  this->eeg_buffer = std::vector<eeg_msgs::msg::Sample>();
...
bool EegGatherer::handle_state__gather_data(double_t current_time, const std::shared_ptr<eeg_msgs::msg::Sample> msg) {
...
void EegGatherer::handle_eeg_sample(const std::shared_ptr<eeg_msgs::msg::Sample> msg) {
...
std::vector<eeg_msgs::msg::Sample>& EegGatherer::get_eeg_buffer() {
  assert (is_finished());
