...
asmo = struct( ...
    'mode', {'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h', 'h'}, ...
    'duration', {5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5 *1e-6, 5*1e-6} ...
);
