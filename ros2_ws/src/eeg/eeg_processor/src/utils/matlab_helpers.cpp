...
Event convert_matlab_event_to_event(matlab_event event) {
  ...
  if (event.event_type == CHARGE) {
    ...
    fpga_event.charge.event_info.execution_time = event.b_event_info.execution_time;
    ...
    fpga_event.pulse.event_info.execution_time = event.b_event_info.execution_time;
    ...
    fpga_event.discharge.event_info.execution_time = event.b_event_info.execution_time;
    ...
    fpga_event.signal_out.event_info.execution_time = event.b_event_info.execution_time;
