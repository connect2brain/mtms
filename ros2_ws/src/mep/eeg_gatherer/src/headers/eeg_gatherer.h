...
#include "shared_interfaces/msg/sample.hpp"
...
public:
  ...
  void handle_eeg_sample(const std::shared_ptr<shared_interfaces::msg::Sample> msg);
  bool is_finished();
  bool success();
  std::vector<shared_interfaces::msg::Sample>& get_eeg_buffer();
...
private:
  ...
  bool handle_state__gather_data(double_t current_time, const std::shared_ptr<shared_interfaces::msg::Sample> msg);

  std::vector<shared_interfaces::msg::Sample> eeg_buffer;
