...
from ui_interfaces.srv import RemovePulseSequence
...
class RemovePulseSequenceNode(StateNode):
    ...
    def __init__(self):
        ...
        self.create_service(RemovePulseSequence, '/mtms/planner/remove_pulse_sequence', self.remove_pulse_sequence_callback)
