...
void start_device(const std::shared_ptr<mtms_device_interfaces::srv::StartDevice::Request> request,
...
public:
  StartDevice()
      : Node("start_device") {
    start_device_service_ = this->create_service<mtms_device_interfaces::srv::StartDevice>("/fpga/start_device", start_device);
  }
